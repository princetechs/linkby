...
CREATE TABLE `Link` (
    ...
    INDEX `idx_link_accountId`(`accountId`),
    PRIMARY KEY (`id`)
...
-- AddForeignKey
ALTER TABLE `Link` ADD CONSTRAINT `Link_accountId_fkey` FOREIGN KEY (`accountId`) REFERENCES `accounts`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
